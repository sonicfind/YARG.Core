...
namespace YARG.Core.NewLoading
{
    ...
    {
        protected readonly AllocatedArray<OverdrivePhrase> _overdrives;
        ...
        protected BasePlayer(AllocatedArray<OverdrivePhrase> overdrives, SyncTrack2 sync, YargProfile profile)
        {
            Sync = sync;
            Profile = profile;
            Name = profile.Name;
