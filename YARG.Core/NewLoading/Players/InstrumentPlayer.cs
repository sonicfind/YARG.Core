...
namespace YARG.Core.NewLoading.Players
{
        ...
        where TSubNote : unmanaged
    {
        ...
        private readonly AllocatedArray<SoloPhrase> _soloes;
        private int _soloIndex = 0;

        public InstrumentPlayer(YARGNativeSortedList<DualTime, TNote> notes, YARGNativeList<TSubNote> subNotes, AllocatedArray<SoloPhrase> soloes, AllocatedArray<OverdrivePhrase> overdrives, SyncTrack2 sync, YargProfile profile)
