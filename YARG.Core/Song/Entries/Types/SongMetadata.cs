...
namespace YARG.Core.Song
{
    public struct SongMetadata
    {
        ...
        public static readonly string DEFAULT_NAME = "Unknown Name";
        public static readonly string DEFAULT_ARTIST = "Unknown Artist";
        public static readonly string DEFAULT_ALBUM = "Unknown Album";
        public static readonly string DEFAULT_GENRE = "Unknown Genre";
        public static readonly string DEFAULT_CHARTER = "Unknown Charter";
        public static readonly string DEFAULT_SOURCE = "Unknown Source";
