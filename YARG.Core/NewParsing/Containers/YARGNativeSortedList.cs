...
{
    public sealed unsafe class YARGNativeSortedList<TKey, TValue> : ISortedList<TKey, TValue>, IDisposable
        ...
        where TValue : unmanaged
    {
        ...
        private void Grow()
        {
            int newcapacity = _capacity == 0 ? ISortedList<TKey, TValue>.DEFAULT_CAPACITY : 2 * _capacity;
