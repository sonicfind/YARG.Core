...
namespace YARG.Core.NewParsing
{
    ...
    {
        public static YARGChart LoadSingle(string filename, in SongMetadata metadata, in ParseSettings settings, HashSet<MidiTrackType>? activeInstruments)
        {
        ...
        public static YARGChart LoadSingle(Stream stream, in SongMetadata metadata, in ParseSettings settings, HashSet<MidiTrackType>? activeInstruments)
        {
            ...
            LoadTracks(chart, sync, midi, ref encoding, activeInstruments);
            YARGChartFinalizer.FinalizeBeats(chart);
            return chart;
        }

        public static YARGChart LoadMulti(Stream mainStream, Stream? updateStream, Stream? upgradeStream, in SongMetadata metadata, in ParseSettings settings, HashSet<MidiTrackType>? activeInstruments)
        {
            ...
            if (updateStream != null)
            {
                ...
                LoadTracks(chart, updateSync, updateMidi, ref encoding, activeInstruments);
            }
            ...
            if (upgradeStream != null)
            {
                ...
                LoadTracks(chart, upgradeSync, upgradeMidi, ref encoding, activeInstruments);
            }
        ...
        private static void LoadTracks(YARGChart chart, SyncTrack2 sync, YARGMidiFile midi, ref Encoding encoding, HashSet<MidiTrackType>? activeInstruments)
        {
