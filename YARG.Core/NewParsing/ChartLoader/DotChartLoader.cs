...
namespace YARG.Core.NewParsing
{
    public static partial class YARGDotChartLoader
    {
        ...
        public static YARGChart Load(in FixedArray<byte> file, in SongMetadata metadata, in LoaderSettings settings, IniModifierCollection? modifiers, DrumsType drumsInChart, HashSet<Instrument>? activeTracks)
        {
            YARGChart chart;
