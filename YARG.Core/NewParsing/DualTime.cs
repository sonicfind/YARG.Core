...
namespace YARG.Core.NewParsing
{
    ...
    public struct DualTime : IEquatable<DualTime>, IComparable<DualTime>
    {
        ...
        public static void SetTruncationLimit(ParseSettings settings, long defaultThreshold)
        {
            TruncationLimit = settings.SustainCutoffThreshold != ParseSettings.SETTING_DEFAULT ? settings.SustainCutoffThreshold : defaultThreshold;
        }
