...
namespace YARG.Core.IO
{
    ...
    public static class YARGChartFileReader
    {
        ...
        public static readonly Dictionary<string, IniModifierOutline> CHART_MODIFIERS = new()
        {
            ...
            { "BassStream",    new("BassStream", ModifierType.String) },
            { "Charter",       new("charter", ModifierType.String) },
            { "CrowdStream",   new("CrowdStream", ModifierType.String) },
            { "Difficulty",    new("diff_band", ModifierType.Int32) },
            { "Drum2Stream",   new("Drum2Stream", ModifierType.String) },
            { "Drum3Stream",   new("Drum3Stream", ModifierType.String) },
            { "Drum4Stream",   new("Drum4Stream", ModifierType.String) },
            { "DrumStream",    new("DrumStream", ModifierType.String) },
            { "Genre",         new("genre", ModifierType.String) },
            { "GuitarStream",  new("GuitarStream", ModifierType.String) },
            { "HarmonyStream", new("HarmonyStream", ModifierType.String) },
            { "KeysStream",    new("KeysStream", ModifierType.String) },
            { "MusicStream",   new("MusicStream", ModifierType.String) },
            ...
            { "RhythmStream",  new("RhythmStream", ModifierType.String) },
            { "VocalStream",   new("VocalStream", ModifierType.String) },
