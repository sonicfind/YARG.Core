...
namespace YARG.Core.IO
{
    public sealed class YARGMidiTrack : IDisposable
    {
        ...
        /// <summary>
        /// Processes the tick position VLQ and event type, channel, and/or length
        ...
        /// <returns>Whether to continue processing events (false if the EndOfTrack event was reached)</returns>
